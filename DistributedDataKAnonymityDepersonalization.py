import random
import numpy as np
from utility.algorithms import mode, suppression, aggregation
from groupjoin import count_column_params_for_loss, GroupJoinKAnonymity, GroupJoinAggregation, GroupJoinDepersonalizator
...
class DistributedDataOwnerKAnonymityDepersonalizator:
    ...
    def count_columns_params(self):
        self.columns_params = count_column_params_for_loss(self.__quasi_identifiers, self.quasi_identifiers_types)
